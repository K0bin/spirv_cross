...
pub mod root {
    ...
    pub mod spirv_cross {
        ...
        pub type MSLShaderInputFormat = ::std::os::raw::c_uint;
        #[repr(C)]
        #[derive(Debug, Copy, Clone)]
    ...
    pub struct ScBufferRange {
        ...
        pub offset: root::size_t,
        pub range: root::size_t,
    }
    #[repr(C)]
    #[derive(Debug, Copy, Clone)]
    ...
    pub struct ScType {
        ...
        pub member_types_size: root::size_t,
        pub array: *mut u32,
        pub array_size_literal: *mut bool,
        pub array_size: root::size_t,
